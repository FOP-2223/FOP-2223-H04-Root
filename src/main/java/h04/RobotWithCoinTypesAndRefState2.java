 ...
 */
public class RobotWithCoinTypesAndRefState2 extends RobotWithCoinTypes implements RobotWithReferenceState{
     ...
     */
    public RobotWithCoinTypesAndRefState2(int x, int y, Direction direction, int numberOfSilverCoins,
